...
Direct writes OK for: `~/.claude/**`, `.omc/**`, `.claude/**`. CLAUDE.md / AGENTS.md changes follow this repo's `maintenance-protocol.md` — do not treat this line as overriding that protocol.
</model_routing>
